...
This project demonstrates how to design and deploy a **3-Tier AWS VPC architecture** using **Terraform AWS VPC Module**.  
It uses Terraform modules, variables, locals, and auto-loaded variable files to build a reusable and standardized VPC setup.

---
## 🏗️ Architecture
- **Public Subnets** → For Load Balancers / Bastion hosts
- **Private Subnets** → For Application Servers
- **Database Subnets** → For RDS / Database layer
